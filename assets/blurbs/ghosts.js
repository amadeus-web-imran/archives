...
if (!Halloween.offset) Halloween.offset = { X: 30, Y: 20 };
if(window.innerWidth)
{
	gX=function(){return innerWidth - Halloween.offset.X;};
	gY=function(){return innerHeight - Halloween.offset.Y;};
}
else
{
	gX=function(){return document.body.clientWidth-30 - Halloween.offset.X;};
	gY=function(){return document.body.clientHeight-30 - Halloween.offset.Y;};
}
